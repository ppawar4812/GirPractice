...
public class Test_5_ResponsiblePersonInfo {
	...
	public static void main(String[] args) throws InterruptedException  {
		...
		driver.findElement(By.xpath("//*[@id='formly_29_input_Name_3']")).sendKeys("Jon Joni");
		
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id='formly_29_input_PAN_4']")).sendKeys("QQQPQ0031Q");
		
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id='formly_29_input_Designation_5']")).sendKeys("Advisor");
		
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id='formly_29_input_MobileNo_6']")).sendKeys("5555555555");
		
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id='formly_29_input_EmailId_7']")).sendKeys("joy031@yopmail.com");
		
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("/html/body/app-root/tds-layout/div[2]/div/div/div/div/div/div/div/deductor-details/div[2]/app-responsible-person-info/div[2]/div/button[2]")).click();
